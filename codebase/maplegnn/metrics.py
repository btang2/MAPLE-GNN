...
#code is cloned from open-source repository from Jha et al., PPI-GNN: https://github.com/JhaKanchan15/PPI_GNN/

def get_cross_entropy(actual, predicted): #from numpy implementation, binary cross entropy
    
    pred = np.clip(predicted, 1e-7, 1 - 1e-7)
